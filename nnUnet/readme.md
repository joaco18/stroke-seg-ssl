# DISCLAIMER:
Most of the code inside this subfolder is based on the original code of [nnUnet](https://github.com/MIC-DKFZ/nnUNet/). Basically some extra funcionalities were added. This was originally a fork from such repository but later merged here to unify the codebase of the project.
