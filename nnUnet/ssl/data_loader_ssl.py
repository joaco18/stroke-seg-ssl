...
class Dataset3D(Dataset):
    def __init__(
        ...
        # Set default values for some config attributes
        ...
        if self.apply_sym_tr:
            print('\nUsing symmetry augmentation \n')
